...
## 正文  
　　（[源代码](https://github.com/HGYS/computationalphysics_N2013301020113/blob/master/4-1.py)），计算得到的数据([pickle形式](https://github.com/HGYS/computationalphysics_N2013301020113/blob/master/4-2.txt)，[txt数据](https://github.com/HGYS/computationalphysics_N2013301020113/blob/master/4-3.txt))，截图([指令窗](https://github.com/HGYS/computationalphysics_N2013301020113/upload/master),[数据结果](https://github.com/HGYS/computationalphysics_N2013301020113/blob/master/4-5.pngr))  
...
　　![衰变图片](https://github.com/HGYS/computationalphysics_N2013301020113/blob/master/4-5.png) 
## 致谢  
